...
async function findParent(cwd: string, predicate: (dir: string) => Promise<boolean>): Promise<string | null> {
 ...
 * @param cwd
 */
export async function findGitRoot(git: SimpleGit, cwd: string): Promise<string> {

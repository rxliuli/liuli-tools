 ...
 */
export declare function loadResource(url: RequestInfo, dom: HTMLImageElement | HTMLAudioElement | HTMLVideoElement | HTMLTrackElement | HTMLScriptElement, init?: RequestInit): Promise<void>;

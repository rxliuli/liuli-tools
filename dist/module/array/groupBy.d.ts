 ...
 */
export declare function groupBy<T, K, R>(arr: T[], kFn: ArrayCallback<T, K>, vFn: ArrayReduceCallback<T, R[]>): Map<K, R[]>;
/**
 * js 数组按照某个条件进行分组
 *
 * @param arr 要进行分组的数组
 ...
 */
export declare function groupBy<T = any, K = any, V = []>(arr: T[], kFn: ArrayCallback<T, K>, vFn: ArrayReduceCallback<T, V>, init: Supplier<V>): Map<K, V>;

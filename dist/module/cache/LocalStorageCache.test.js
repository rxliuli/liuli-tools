...
describe('test LocalStorageCache', () => {
    ...
    it('test touch', () => __awaiter(this, void 0, void 0, function* () {
        const cache = new LocalStorageCache();
        const k = '1';
        const v1 = '1';
        // @ts-ignore
        ...
        yield repeatedCall(4, () => __awaiter(this, void 0, void 0, function* () {
            yield wait(5);
            expect(cache.touch(k)).toBe(v1);
        }));
        expect(cache.touch(k)).toBe(v1);
    }));
    it('test global default CacheOption', () => __awaiter(this, void 0, void 0, function* () {
        // @ts-ignore
        const cache = new LocalStorageCache({
            timeout: 10,
        });
    ...
    it('test use set CacheOption override global default CacheOption', () => __awaiter(this, void 0, void 0, function* () {
        // @ts-ignore
        const cache = new LocalStorageCache({
            timeout: 10,
        });
    ...
    it('test auto clear expired', () => __awaiter(this, void 0, void 0, function* () {
        const cache = new LocalStorageCache();
        // @ts-ignore
        cache.set('1', 1, {
            timeout: 10,
    ...
    it('test auto clear expired for sleep', () => __awaiter(this, void 0, void 0, function* () {
        const cache = new LocalStorageCache();
        // @ts-ignore
        cache.set('1', 1, {
            timeout: 10,

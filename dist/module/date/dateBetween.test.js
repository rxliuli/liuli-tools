...
describe('test dateBetween', () => {
    ...
    it('test decimals', () => {
        const between = dateBetween(new Date('2018-12-11T00:00:00.000'), new Date('2019-12-11T01:10:10.100'));
        expect(between.milliSecond()).toBe((((365 * 24 + 1) * 60 + 10) * 60 + 10) * 1000 + 100);

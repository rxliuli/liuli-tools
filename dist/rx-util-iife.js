var rx = (function (exports) {
  ...
  ***************************************************************************** */
  ...
  class CacheUtil {
       ...
       * @returns 包装后的函数
       */
      static once(fn, { identity = fn.toString(), timeout = TimeoutInfinite, } = {}) {
       ...
       * @returns 带有缓存功能的函数
       */
      static onceOfSameParam(fn, { identity = fn.toString(), timeout = TimeoutInfinite, } = {}) {
...
//# sourceMappingURL=rx-util-iife.js.map
